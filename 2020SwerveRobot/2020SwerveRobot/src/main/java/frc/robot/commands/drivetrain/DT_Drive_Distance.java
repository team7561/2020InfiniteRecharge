...
*/
public class DT_Drive_Distance extends CommandBase {
    ...
    */
    ...
    public DT_Drive_Distance(Drivetrain subsystem, double speed, double distance){
    ...
    public void execute() {
        ...
        m_difference = m_distance - (m_subsystem.getFrontRightEncoder() + m_subsystem.getFrontLeftEncoder())/2;
